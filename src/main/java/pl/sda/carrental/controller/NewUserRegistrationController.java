...
@Controller
public class NewUserRegistrationController implements WebMvcConfigurer {
    private final RoleRepository roleRepository;
    private final UserRegistrationService userRegistrationService;

    public NewUserRegistrationController(RoleRepository roleRepository, UserRegistrationService userRegistrationService) {
...
//        userRegistrationDTO.setRole(roleRepository.findByRoleName(PrincipalRole.ADMIN.name()).get());
